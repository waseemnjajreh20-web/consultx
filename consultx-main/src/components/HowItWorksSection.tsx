...
const steps = [
  {
    ...
    titleAr: "ابدأ المحادثة",
    titleEn: "Start the Conversation",
    descAr: "اطرح سؤالك أو صِف مشكلتك الهندسية. وكيل الأوركسترا يستلم طلبك ويصنف المبنى ويوجهك للوضع المناسب.",
    descEn: "Ask your question or describe your engineering challenge. The Orchestra Agent receives your request, classifies the building, and guides you to the right mode.",
  ...
  },
  {
    ...
    titleAr: "احصل على استشارة مرجعية",
    titleEn: "Get Code-Referenced Advice",
    descAr: "12 وكيلاً ذكياً يعملون بالتزامن: استخراج المراجع عبر GraphRAG، مطابقة حرفية عبر مراجع الكود، وحل التعارضات — كل رد ينتهي برقم الصفحة والسكشن.",
    descEn: "12 specialized AI agents work in parallel: retrieving references via GraphRAG, verbatim code matching, and resolving conflicts — every response ends with a page number and section.",
  ...
  },
  {
    ...
    titleAr: "حلّل مخططاتك",
    titleEn: "Analyze Your Drawings",
    descAr: "Vision AI يقرأ مخططاتك ويستخرج البيانات المكانية، مع فحص متوازي لـ SBC 201 وSBC 801 وNFPA في آن واحد.",
    descEn: "Vision AI reads your drawings and extracts spatial data, with parallel inspection of SBC 201, SBC 801, and NFPA simultaneously.",
    lineGradient: "",
  },
];
