...
export const translations = {
  ar: {
    ...
    visionStage1: "قراءة المفتاح وتصنيف المبنى...",
    visionStage2: "التحقق من القياسات وبناء قائمة الفحص...",
    visionStage3: "استرجاع المراجع...",
    visionStage4: "دمج النتائج...",
    visionStage5: "إنشاء التقرير...",
    blueprintMode: "وضع تحليل المخططات",
    extractedData: "البيانات المستخرجة",
    legendFound: "تم العثور على مفتاح الرسم",
    legendNotFound: "لم يتم العثور على مفتاح رسم",
    scaleDetected: "المقياس المكتشف",
    detectedElements: "العناصر المكتشفة",
    dimensionValidation: "التحقق من القياسات",
    scanningFileType: "جاري تحديد نوع الملف...",
    analyzingImage: "جاري تحليل الصورة...",
    pdfTooBig: "حجم PDF يتجاوز 25 ميجابايت",
    pdfConversionError: "خطأ في تحويل ملف PDF",
    pdfUploaded: "تم رفع PDF",
    pagesExtracted: "صفحات مستخرجة",
  ...
  en: {
    ...
    visionStage1: "Reading legend & classifying...",
    visionStage2: "Validating dimensions & building checklist...",
    visionStage3: "Retrieving references...",
    visionStage4: "Merging results...",
    visionStage5: "Generating report...",
    blueprintMode: "Blueprint Analysis Mode",
    extractedData: "Extracted Data",
    legendFound: "Legend Found",
    legendNotFound: "No Legend Found",
    scaleDetected: "Scale Detected",
    detectedElements: "Detected Elements",
    dimensionValidation: "Dimension Validation",
    scanningFileType: "Scanning file type...",
    analyzingImage: "Analyzing image...",
    pdfTooBig: "PDF file exceeds 25MB limit",
    pdfConversionError: "Error converting PDF file",
